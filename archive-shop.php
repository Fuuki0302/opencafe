...
<?php get_header(); ?>
    ...
    <div class="l-firstview__wrapper">
        <div class="l-firstView l-shop__View">
    ...
    <div class="l-ass">
        <div class="l-ass__inner">
        <?php if(function_exists('bcn_display')) : ?>
            <ul class="breadcrumb w_shop-breadcrumb"  itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        <?php endif?>
            ...
            <?php while (have_posts()) :?>
                ...
                <div class="p-ass__items">
                    <h2 class="p-ass__ttl">OPEN CAFE  <span class="p-ass__des"><?php the_title();?></span></h2>
                    ...
                    <div class="p-access__info--sec">
                        <dl class="p-access__flex">
                            <div class="p-access__flexLeft">
                                <dl>
                                    <div class="p-ac__flex">
                                        <dt class="p-ac__ttl" >住所</dt>
                                        <dd class="p-ac__txt" ><?php echo nl2br(get_field('access')); ?></dd>
                                    </div>
                                    <div class="p-ac__flex">
                                        <dt class="p-ac__ttl" >TEL</dt>
                                        <dd class="p-ac__txt" ><?php the_field('tel');?></dd>
                                    </div>
                                    <div class="p-ac__flex">
                                        <dt class="p-ac__ttl" >Mail</dt>
                                        <dd class="p-ac__txt" ><?php the_field('email');?></dd>
                                    </div>
                                </dl>
                            </div>
                            <div class="access-flexRight_second">
                                <dl>
                                    <div class="p-ac__flex">
                                        <dt class="p-ac__ttl" >営業時間</dt>
                                        <dd class="p-ac__txt" ><?php the_field('time');?></dd>
                                    </div>
                                    <div class="p-ac__flex">
                                        <dt class="p-ac__ttl" >定休日</dt>
                                        <dd class="p-ac__txt" ><?php the_field('holiday');?></dd>
                                    </div>
                                    <div class="p-ac__flex">
                                        <dt class="p-ac__ttl" >座席</dt>
                                        <dd class="p-ac__txt" ><?php the_field('seat');?></dd>
                                    </div>
                                </dl>
                            </div>
                        </dl>
